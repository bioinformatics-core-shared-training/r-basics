...
Now clearly 7 is the answer but what's the `[1]` that you see before it?

Sometimes operations will return more than one value and these may get printed
...
A vector is an ordered series of values and is the simplest data structure in R.
The `rivers` data set is an example of a vector.
